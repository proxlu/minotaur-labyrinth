...
def game(screen):
    ...
    shock = pygame.mixer.Sound("./Sounds/shock.wav")
    ...
    vision_off = pygame.image.load("./MiscImages/vision_limiter_off.png")
    ...
    visible_off = labyrinthSprites.NoVisionLimiter(screen, vision_off)
